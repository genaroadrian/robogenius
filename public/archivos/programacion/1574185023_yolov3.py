...
class YOLO(object):
    def __init__(self):
        self.model_path = 'yolo3/yolov3.h5'
        self.anchors_path = 'yolo3/yolo_anchors.txt'
        self.classes_path = 'yolo3/coco_classes.txt'
        self.score = 0.3
        self.iou = 0.5
    ...
    def detect_image(self, image, animals=1, predictEdge=0, pos=-1, database=None, verbose=True):
        predictEdge /= 100
        if self.is_fixed_size:
            assert self.model_image_size[0] % 32 == 0, 'Multiples of 32 required'
            assert self.model_image_size[1] % 32 == 0, 'Multiples of 32 required'
