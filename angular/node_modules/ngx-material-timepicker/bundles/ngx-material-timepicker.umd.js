(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/forms'), require('luxon'), require('@angular/animations'), require('@angular/platform-browser'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-material-timepicker', ['exports', 'rxjs', 'rxjs/operators', '@angular/forms', 'luxon', '@angular/animations', '@angular/platform-browser', '@angular/core', '@angular/common'], factory) :
    (factory((global['ngx-material-timepicker'] = {}),global.rxjs,global.rxjs.operators,global.ng.forms,global.luxon,global.ng.animations,global.ng.platformBrowser,global.ng.core,global.ng.common));
}(this, (function (exports,rxjs,operators,forms,luxon,animations,platformBrowser,i0,common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxMaterialTimepickerComponent = /** @class */ (function () {
        ...
        NgxMaterialTimepickerComponent.propDecorators = {
            ...
            timepickerComponent: [{ type: i0.ViewChild, args: ['timepickerww',] }],
    ...
    var NgxMaterialTimepickerToggleComponent = /** @class */ (function () {
        ...
        NgxMaterialTimepickerToggleComponent.propDecorators = {
            ...
            customIcon: [{ type: i0.ContentChild, args: [NgxMaterialTimepickerToggleIconDirective,] }]
        };
    ...
    var NgxMaterialTimepickerFaceComponent = /** @class */ (function () {
        ...
        NgxMaterialTimepickerFaceComponent.propDecorators = {
            ...
            clockFace: [{ type: i0.ViewChild, args: ['clockFace',] }],
            clockHand: [{ type: i0.ViewChild, args: ['clockHand',] }],
    ...
    var OverlayDirective = /** @class */ (function () {
        ...
        OverlayDirective.propDecorators = {
            preventClick: [{ type: i0.Input, args: ['overlay',] }],
            onClick: [{ type: i0.HostListener, args: ['click', ['$event'],] }]
        };
